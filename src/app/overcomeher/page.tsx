...
import { COMMUNITY_ROOMS, MEMBERSHIP_TIERS, IMAGES } from "@/lib/constants";
    ...
    <>
      ...
      <Section variant="warm" size="lg">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {[
            "Is done with surface-level wellness and wants real transformation",
            "Desires sisterhood, safety, and connection with women who get it",
            "Is ready to take care of herself \u2014 for real this time",
            "Is craving structure and accountability to keep growth on track",
            "Knows healing matters but hasn\u2019t had the space to make it happen",
            ...
            <AnimateOnScroll key={item} animation="fade-up" delay={index * 80}>
              <div className="p-5 rounded-xl bg-white border border-warm-100 flex items-start gap-3 h-full">
      ...
      <Section variant="warm" size="lg">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {COMMUNITY_ROOMS.slice(0, 6).map((room, index) => (
            <AnimateOnScroll key={room.slug} animation="fade-up" delay={index * 80}>
              <div className="p-6 rounded-2xl bg-white border border-warm-100 hover:shadow-md transition-all h-full">
          ...
          {[
            {
              ...
              description:
                "You enter the circle and begin to reconnect with the parts of yourself you've been neglecting. Through guided journaling, community, and intentional rest, you remember who you are beneath the roles, the responsibilities, and the exhaustion.",
            },
            {
              step: "02",
              title: "Rebuild",
              ...
              description:
                "You engage with the content, the conversations, and the community. You begin rebuilding your habits, your boundaries, and your sense of self. The healing isn't just emotional — it's practical, spiritual, and lasting.",
            },
            {
              step: "03",
              title: "Rise",
              ...
              description:
                "You're not the same woman who walked in. You've done the work, built the habits, and found your people. Now you rise — not perfect, but whole. And you help others do the same.",
            },
          ].map((phase, index) => (
            <AnimateOnScroll key={phase.step} animation="fade-up" delay={index * 150}>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {[
            ...
            <AnimateOnScroll key={t.name} animation="fade-up" delay={index * 100}>
              <div className="p-8 rounded-2xl bg-white border border-warm-100 h-full">
